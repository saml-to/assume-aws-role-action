 ...
 *
 * The version of the OpenAPI document: 1.0.65-3
 *
 *
...
export const ConfigApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    saveConfig: async (
      org: string,
      githubSlsRestApiSaveConfigRequest: GithubSlsRestApiSaveConfigRequest,
      force?: boolean,
      ...
      assertParamExists(
        'saveConfig',
        'githubSlsRestApiSaveConfigRequest',
        githubSlsRestApiSaveConfigRequest,
      );
      const localVarPath = `/api/v1/config/orgs/{org}`.replace(
        `{${'org'}}`,
        encodeURIComponent(String(org)),
      );
...
export const ConfigApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async saveConfig(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<GithubSlsRestApiSaveConfigResponse>
    > {
...
export const ConfigApiFactory = function (
  ...
  return {
    ...
    saveConfig(
      ...
      force?: boolean,
      options?: any,
    ): AxiosPromise<GithubSlsRestApiSaveConfigResponse> {
      return localVarFp
        .saveConfig(org, githubSlsRestApiSaveConfigRequest, force, options)
...
export const HealthApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async get(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<GithubSlsRestApiHealthResponse>
    > {
...
export const IDPApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    assumeRole: async (
      ...
      const localVarPath = `/api/v1/idp/roles/{role}/assume`.replace(
        `{${'role'}}`,
    ...
    assumeRoleForBrowser: async (
      ...
      const localVarPath = `/api/v1/idp/roles/{role}/assume/browser`.replace(
        `{${'role'}}`,
        encodeURIComponent(String(role)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    encrypt: async (
      org: string,
      githubSlsRestApiEncryptRequest: GithubSlsRestApiEncryptRequest,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'org' is not null or undefined
      ...
      assertParamExists(
        'encrypt',
        'githubSlsRestApiEncryptRequest',
        githubSlsRestApiEncryptRequest,
      );
      const localVarPath = `/api/v1/idp/orgs/{org}/encrypt`.replace(
        `{${'org'}}`,
        encodeURIComponent(String(org)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getOrgConfig: async (
      ...
      const localVarPath = `/api/v1/idp/orgs/{org}/config`.replace(
        `{${'org'}}`,
        encodeURIComponent(String(org)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getOrgMetadata: async (org: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/api/v1/idp/orgs/{org}/metadata`.replace(
        `{${'org'}}`,
        encodeURIComponent(String(org)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getOrgRepo: async (org: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/api/v1/idp/orgs/{org}`.replace(
        `{${'org'}}`,
        encodeURIComponent(String(org)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    providerLogin: async (
      ...
      const localVarPath = `/api/v1/idp/logins/{provider}/login`.replace(
        `{${'provider'}}`,
  ...
  return {
    ...
    async assumeRole(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<GithubSlsRestApiSamlResponseContainer>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.assumeRole(
        role,
        org,
        provider,
        options,
    ...
    async assumeRoleForBrowser(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<GithubSlsRestApiAssumeBrowserResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.assumeRoleForBrowser(
        role,
        org,
        provider,
        options,
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.assumeRoleForRepo(
        org,
        repo,
        role,
        provider,
    ...
    async encrypt(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<GithubSlsRestApiEncryptResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.encrypt(
        org,
        githubSlsRestApiEncryptRequest,
        options,
      );
    ...
    async getIdentity(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<GithubSlsRestApiIdentityResponse>
    > {
    ...
    async getOrgConfig(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<GithubSlsRestApiConfigV20220101>
    > {
    ...
    async getOrgMetadata(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<GithubSlsRestApiMetadataResponse>
    > {
    ...
    async getOrgRepo(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<GithubSlsRestApiOrgRepoResponse>
    > {
    ...
    async listLogins(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<GithubSlsRestApiListResponseLoginResponse>
    > {
    ...
    async listOrgRepos(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<GithubSlsRestApiListResponseOrgRepoResponse>
    > {
    ...
    async listRoles(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<GithubSlsRestApiListResponseRoleResponse>
    > {
    ...
    async providerLogin(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<GithubSlsRestApiLoginResponseContainer>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.providerLogin(
        provider,
        org,
        options,
      );
    ...
    async refreshOrgRepoConfig(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<GithubSlsRestApiOrgRepoConfigRefreshResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.refreshOrgRepoConfig(
        org,
        repo,
        dryrun,
        commitSha,
    ...
    async setOrgAndRepo(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<GithubSlsRestApiOrgRepoLogin>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.setOrgAndRepo(
        org,
        repo,
        force,
        create,
...
export const IDPApiFactory = function (
  ...
  return {
    ...
    assumeRoleForBrowser(
      ...
      return localVarFp
        .assumeRoleForBrowser(role, org, provider, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    assumeRoleForRepo(
      ...
      return localVarFp
        .assumeRoleForRepo(org, repo, role, provider, commitSha, configOwner, configPath, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    encrypt(
      ...
      githubSlsRestApiEncryptRequest: GithubSlsRestApiEncryptRequest,
      options?: any,
    ): AxiosPromise<GithubSlsRestApiEncryptResponse> {
      return localVarFp
    ...
    getOrgConfig(
      ...
      raw?: boolean,
      options?: any,
    ): AxiosPromise<GithubSlsRestApiConfigV20220101> {
    ...
    refreshOrgRepoConfig(
      ...
      return localVarFp
        .refreshOrgRepoConfig(org, repo, dryrun, commitSha, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    setOrgAndRepo(
      ...
      create?: boolean,
      options?: any,
    ): AxiosPromise<GithubSlsRestApiOrgRepoLogin> {
      return localVarFp
        .setOrgAndRepo(org, repo, force, create, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export const TemplateApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    createCloudFormation: async (
      ...
      const localVarPath = `/api/v1/template/orgs/{org}/cloudformation`.replace(
        `{${'org'}}`,
        encodeURIComponent(String(org)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    getConfigVariables: async (
      org: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'org' is not null or undefined
      assertParamExists('getConfigVariables', 'org', org);
      const localVarPath = `/api/v1/template/orgs/{org}/configvariables`.replace(
        `{${'org'}}`,
        encodeURIComponent(String(org)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
  ...
  return {
    ...
    async createCloudFormation(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<GithubSlsRestApiCloudFormationResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createCloudFormation(
        org,
        managedPolicy,
        options,
      );
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getCloudFormation(
        org,
        templateId,
        options,
      );
    ...
    async getConfigVariables(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<GithubSlsRestApiConfigVariablesResponse>
    > {
...
export const TemplateApiFactory = function (
  ...
  return {
    ...
    createCloudFormation(
      ...
      return localVarFp
        .createCloudFormation(org, managedPolicy, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    getCloudFormation(
      ...
      return localVarFp
        .getCloudFormation(org, templateId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    getConfigVariables(
      ...
      return localVarFp
        .getConfigVariables(org, options)
        .then((request) => request(axios, basePath));
    },
  };
};
